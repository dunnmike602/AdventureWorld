...
namespace DiagramDesigner.Symbols
{
    ...
    internal class OrthogonalPathFinder
    {
        ...
        internal static List<Point> GetConnectionLine(ConnectorInfo source, Point sinkPoint, ConnectorOrientation preferredOrientation)
        {
            ...
            if (preferredOrientation != ConnectorOrientation.None)
                ...
                linePoints = OptimizeLinePoints(linePoints, new[] { rectSource }, source.Orientation, GetOpositeOrientation(source.Orientation));
